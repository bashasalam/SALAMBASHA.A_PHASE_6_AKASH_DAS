...
public class NonUserBuyingSuccessTest {
	...
	//	WebDriver driver = new FirefoxDriver();
		...
		Thread.sleep(1000);
		 ...
		 driver.findElement(By.linkText("Register")).click();
		    ...
		    driver.findElement(By.id("fullName")).sendKeys("fadheela2");
		    driver.findElement(By.id("email")).sendKeys("fadheela2@gmail.com");
		    driver.findElement(By.id("mobile")).sendKeys("9874512635");
